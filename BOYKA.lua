...
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/Ninja3/master/BOYKA.lua')
...
os.execute('rm -rf BOYKA.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/NINJABOT/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 1.2v}')
dofile('BOYKA.lua')  
end
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel NINJA 🦅](https://t.me/ninjaIAQ)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
if text ==  ""..Name_Bot..' شنو رئيك بهاذا' and tonumber(msg.Ninjq_to_message_id_) > 0 then     
...
if text == ""..Name_Bot..' تحب هذا' and tonumber(msg.Ninjq_to_message_id_) > 0 then    
function FunBot(extra, result, success) 
